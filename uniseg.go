...
//go:generate go run ./internal/cmd/gen_properties -logprefix=words -property=auxiliary/WordBreakProperty -prefix=wbpr -type=wbProperty wordproperties.go workBreakCodePoints
