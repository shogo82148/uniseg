...
const (
	testCaseURL = `https://www.unicode.org/Public/16.0.0/ucd/auxiliary/%s.txt`
)
...
func parse(url string) ([]byte, error) {
	...
	buf.Grow(120 << 10)
	buf.WriteString(`// Code generated by ./internal/cmd/gen_breaktest/gen_breaktest.go; DO NOT EDIT.
